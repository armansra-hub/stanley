...
The Intelligence page exposes Jev outputs and reversible feedback, and focused research rotates through previously verified company URLs. Event-level clustering of different reports and generated account narratives remain unfinished. Local TAM navigation helpers keep private indexes on the operator's computer; the canonical local grader remains paused, and cloud deployment does not resume it.
