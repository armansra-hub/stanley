...
export async function GET(req: Request) {
  ...
  return NextResponse.json({
    ...
    endpoints: {
      ...
      "GET  /api/agent/intelligence/research-status": "Read-only current TAM first-read, caught-up, source-retry and new/completed research counts. No provider calls or work dispatch.",
