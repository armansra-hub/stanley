...
export default function IntelligenceVisibility(){
 ...
 return <details className="mt-4 rounded border p-3 text-sm"><summary className="cursor-pointer font-medium">Visibility rules and saved-output diagnostics</summary>
  <p className="mt-2 text-xs text-[var(--text-muted)]">Supported operating traits use {DEFAULT_VISIBILITY_POLICY.topicProbability*100}% topic probability and {DEFAULT_VISIBILITY_POLICY.companyRelevance*100}% company relevance. Exploration shows native answers down to 50%, still with direct attribution. It changes this search only; Triggers and TAM grades keep their existing rules.</p>
