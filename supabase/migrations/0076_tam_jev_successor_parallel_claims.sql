-- Prepared successor admission; not applied by this artifact.
...
begin
  ...
  if (
    ...
    where run_id = v_run_id
      ...
      and grade_status = 'reading'
      and claim_expires_at > v_now
  ) >= (case when p_run_slug in ('ars-bs-tam-2026-09-17', 'ars-bs-tam-2026-09-19-jev') then 3 else 1 end) then
