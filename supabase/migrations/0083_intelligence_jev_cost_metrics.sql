-- Report known TypeSafe usage separately from conservative unknown/in-flight holds.
-- Attribution starts with 0082. Historical rows are never relabeled by inference.
begin;
