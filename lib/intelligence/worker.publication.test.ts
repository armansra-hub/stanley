...
vi.mock("./jev", () => ({ evaluateEvidence: mocks.evaluate, estimateEvidenceInputTokens: () => 100,
  JEV_QUESTION_VERSION: "stanley-evidence-v2", JEV_PUBLIC_SCALE_QUESTION_VERSION: "stanley-public-scale-v1", JEV_BUSINESS_SERVICES_QUESTION_VERSION: "stanley-business-services-v1" }));
